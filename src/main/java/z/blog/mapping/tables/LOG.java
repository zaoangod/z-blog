...
public class LOG extends TableImpl<LogRecord> {
    ...
    private static final long serialVersionUID = 1750807297;
    ...
    /**
     * The column <code>t_log.title</code>.
     */
    public final TableField<LogRecord, String> TITLE = createField(DSL.name("title"), org.jooq.impl.SQLDataType.VARCHAR(100).nullable(false), this, "");
    ...
    /**
     * The column <code>t_log.author_id</code>.
     */
    public final TableField<LogRecord, Integer> AUTHOR_ID = createField(DSL.name("author_id"), org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");
    ...
    /**
     * The column <code>t_log.created</code>.
     */
    public final TableField<LogRecord, Integer> CREATED = createField(DSL.name("created"), org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");
    ...
    public List<UniqueKey<LogRecord>> getKeys() {
        return Arrays.<UniqueKey<LogRecord>>asList(
            ...
            , Internal.createUniqueKey(LOG.T_LOG, "sqlite_autoindex_t_log_1", new TableField[] { LOG.T_LOG.LID }, true)
        );
    }
