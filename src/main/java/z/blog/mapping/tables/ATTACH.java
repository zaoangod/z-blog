...
public class ATTACH extends TableImpl<AttachRecord> {
    ...
    private static final long serialVersionUID = 522332329;
     ...
     */
    public final TableField<AttachRecord, String> NAME = createField(DSL.name("name"), org.jooq.impl.SQLDataType.VARCHAR(100).nullable(false), this, "");

    /**
     * The column <code>t_attach.type</code>.
     */
    public final TableField<AttachRecord, String> TYPE = createField(DSL.name("type"), org.jooq.impl.SQLDataType.VARCHAR(50), this, "");

    /**
     * The column <code>t_attach.key</code>.
     */
    public final TableField<AttachRecord, String> KEY = createField(DSL.name("key"), org.jooq.impl.SQLDataType.VARCHAR(100).nullable(false), this, "");

    /**
     * The column <code>t_attach.created</code>.
     */
    public final TableField<AttachRecord, Integer> CREATED = createField(DSL.name("created"), org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");
